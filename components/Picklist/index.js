...
function _positionResolver(opts, enableSearch) {
    ...
    return _objectSpread(
        _objectSpread({}, _InternalOverlay['default'].defaultPositionResolver(newOpts)),
        {},
        {
            width: trigger.width,
        },
...
var Picklist = (function(_Component) {
    ...
    function Picklist(props) {
        ...
        _this.handleInputClick = _this.handleInputClick.bind(
        ...
        _this.closeAndFocusInput = _this.closeAndFocusInput.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        ...
        (0, _defineProperty2['default'])(
            _this$keyHandlerMap,
            _constants.ESCAPE_KEY,
            _this.closeAndFocusInput,
        ),
        (0, _defineProperty2['default'])(
            _this$keyHandlerMap,
            _constants.TAB_KEY,
