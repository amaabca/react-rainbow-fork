...
var Marker = (function(_Component) {
    ...
    function Marker(props) {
        ...
        _this.getLocationInfo = _this.getLocationInfo.bind(
        ...
        _this.stopAnimation = _this.stopAnimation.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
                ...
                if (latitude && longitude) {
                    return _react['default'].createElement(
                        ...
                        _react['default'].createElement(
                            ...
                            _react['default'].createElement(
                                _textContainer['default'],
                                null,
                                _react['default'].createElement(_label['default'], null, label),
                                _react['default'].createElement('span', null, description),
                            ),
                        ),
                    );
                }
...
function MapMarker(props) {
    return _react['default'].createElement(_context.Consumer, null, function(context) {
        return _react['default'].createElement(
            Marker,
            (0, _extends2['default'])({}, props, context),
        );
    });
}
