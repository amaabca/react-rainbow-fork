...
var _isOptionVisible = _interopRequireDefault(
    require('../../../InternalDropdown/helpers/isOptionVisible'),
);
...
function useKeyboardNavigation(country, list, ref, scrollableRef, itemsRef, handleCountryChange) {
    ...
    var handleActiveChange = (0, _react.useCallback)(
        function(newIndex) {
    ...
    var moveToOption = (0, _react.useCallback)(
        function(newIndex) {
            var currentItem = itemsRef.current[activeIndex.current];
            var newItem = itemsRef.current[newIndex];
