    ...
    return _react['default'].createElement(
        ...
        _react['default'].createElement(
            ...
            _react['default'].createElement('path', {
                d:
                    'M.754 11.109A15.953 15.953 0 000 15.969c0 1.695.265 3.327.754 4.86l15.215.694 15.215-.694c.489-1.533.754-3.165.754-4.86 0-1.695-.265-3.328-.754-4.86l-15.215-.695-15.215.695z',
                fill: '#F0F0F0',
            }),
            _react['default'].createElement(
                'g',
                ...
                _react['default'].createElement('path', {
                    d:
                        'M31.183 11.109l-15.214-.694-15.215.694c-.145.454-.27.917-.374 1.388h31.178c-.105-.47-.23-.934-.375-1.388zM.38 19.44c.104.471.23.934.374 1.389h.002l15.213.694 15.214-.694c.145-.455.27-.918.375-1.389H.38z',
                }),
            ),
            _react['default'].createElement('path', {
                d:
                    'M15.969 31.938c7.124 0 13.158-4.667 15.214-11.11H.754c2.056 6.443 8.09 11.11 15.215 11.11z',
                fill: '#6DA544',
            }),
            _react['default'].createElement('path', {
