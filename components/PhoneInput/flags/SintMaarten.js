...
function SvgSintMaarten(_ref) {
    ...
    return _react['default'].createElement(
        ...
        _react['default'].createElement(
            ...
            _react['default'].createElement('path', {
                d:
                    'M3.187 12.15v4.513c0 2.392 3.124 3.124 3.124 3.124s3.124-.732 3.124-3.124V12.15H3.187z',
                fill: '#D80027',
            }),
            _react['default'].createElement('path', {
                d:
                    'M6.313 18.334c-.58-.208-1.738-.741-1.738-1.67v-3.125h3.472v3.124c0 .933-1.158 1.464-1.734 1.671z',
                fill: '#338AF3',
            }),
            _react['default'].createElement('path', {
                fill: '#F3F3F3',
