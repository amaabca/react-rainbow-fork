...
function AccordionTimelineMarker(props) {
    ...
    var currentName = (0, _react.useMemo)(
        function() {
    ...
    var resolveActiveNamesWhenMultiple = (0, _react.useCallback)(
        function() {
    ...
    var resolveActiveNames = (0, _react.useCallback)(
        function() {
            if (multiple) {
    ...
    var handleToggleMarker = (0, _react.useCallback)(
        function() {
    ...
    var isExpanded = (0, _react.useMemo)(
        function() {
    ...
    var shouldRenderChildren = (0, _react.useMemo)(
        function() {
        ...
        _react['default'].createElement(
            ...
            _react['default'].createElement(
                ...
                _react['default'].createElement(
                    ...
                    _react['default'].createElement(_datetime['default'], null, datetime),
                ),
...
AccordionTimelineMarker.propTypes = {
    ...
    datetime: _propTypes['default'].oneOfType([
        _propTypes['default'].string,
        _propTypes['default'].node,
    ]),
