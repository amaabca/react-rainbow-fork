...
describe('<BasicTimelineMarker/>', function() {
    ...
    it('should render the icon passed', function() {
        var component = (0, _enzyme.mount)(
            _react['default'].createElement(_basicMarker['default'], {
    ...
    it('should render the calendar icon by default', function() {
        var component = (0, _enzyme.mount)(
            _react['default'].createElement(_basicMarker['default'], null),
        );
    ...
    it('should render the description passed', function() {
        ...
        expect(component.find(_description['default']).text()).toBe(
