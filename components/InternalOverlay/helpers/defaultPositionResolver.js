...
var resolvers = [
    _resolverBottomLeft['default'],
    _resolverBottomRight['default'],
    _resolverBottomCenter['default'],
    _resolverUpLeft['default'],
    _resolverUpRight['default'],
    _resolverUpCenter['default'],
    _resolverCenterLeft['default'],
    _resolverCenterRight['default'],
    _resolverTopLeft['default'],
    _resolverTopRight['default'],
];
