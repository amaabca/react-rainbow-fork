...
var PageVerticalNavigation = (function() {
    ...
    (0, _createClass2['default'])(PageVerticalNavigation, [
                                    ...
                                    switch ((_context.prev = _context.next)) {
                                        ...
                                        case 2:
                                            ...
                                            return _context.abrupt(
                                                'return',
                                                new PageVerticalItem(
                                                    ''
                                                        .concat(
                                                            this.rootElement,
                                                            ' [data-id="vertical-item"]:nth-child(',
                                                        )
        ...
        },
        {
            ...
            value: (function() {
                var _getSectionOverflow = (0, _asyncToGenerator2['default'])(
                                    ...
                                    switch ((_context2.prev = _context2.next)) {
                                        ...
                                        case 2:
                                            ...
                                            return _context2.abrupt(
                                                'return',
                                                new PageVerticalSectionOverflow(
                                                    ''
                                                        .concat(
                                                            this.rootElement,
                                                            ' [data-id="vertical-overflow-container"]:nth-child(',
                                                        )
                                                        .concat(itemPosition + 1, ')'),
                                                ),
                                            );
