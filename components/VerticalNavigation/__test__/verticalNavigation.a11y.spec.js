...
describe('<VerticalNavigation/>', function() {
    it(
        'should be accessible when use VerticalSection',
                            ...
                            case 0:
                                ...
                                html = _server['default'].renderToString(
                                    _react['default'].createElement(
                                        ...
                                        _react['default'].createElement(
                                            _VerticalSection['default'],
                                            {
                                                label: 'Section Label',
                                            },
                                            _react['default'].createElement(
                                                _VerticalItem['default'],
                                                {
                                                    name: 'item-1',
                                                    label: 'Recent',
                                                },
    ...
    it(
        'should be accessible when use VerticalSectionOverflow',
        (0, _asyncToGenerator2['default'])(
                            ...
                            case 0:
                                ...
                                html = _server['default'].renderToString(
                                    _react['default'].createElement(
                                        ...
                                        null,
                                        _react['default'].createElement(
                                            _VerticalSectionOverflow['default'],
                                            {
                                                label: 'Section Label',
                                            },
                                            _react['default'].createElement(
