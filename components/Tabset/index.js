...
var Tabset = (function(_Component) {
    ...
    function Tabset(props) {
        ...
        _this.unRegisterTab = _this.unRegisterTab.bind(
        ...
        _this.handleLeftButtonClick = _this.handleLeftButtonClick.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleRightButtonClick = _this.handleRightButtonClick.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.updateButtonsVisibility = _this.updateButtonsVisibility.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        ...
        (0, _defineProperty2['default'])(_this$keyHandlerMap, _constants.RIGHT_KEY, function() {
    ...
    (0, _createClass2['default'])(Tabset, [
        {
            ...
            value: function componentDidMount() {
                this.widthObserver = new _ResizeSensor['default'](
                    ...
                    (0, _debounce['default'])(this.updateButtonsVisibility, 100),
                );
            },
        },
        {
        ...
        },
        {
            ...
            value: function updateTab(tab, nameToUpdate) {
                var tabsetChildren = this.tabsetChildren;
                var newTabsetChildren = (0, _utils.getUpdatedTabsetChildren)(
                    tabsetChildren,
                    tab,
                    nameToUpdate,
                );
        ...
        },
        {
            ...
            value: function scrollToSelectedTab(name) {
                ...
                if (isFirstTab) {
                    ...
                    var totalWidthUpToCurrentTab = (0, _utils.getChildrenTotalWidthUpToClickedTab)(
                        tabsetChildren,
                        tabIndex + 1,
                    );
                    var totalWidthUpToPrevTab = (0, _utils.getChildrenTotalWidthUpToClickedTab)(
                        tabsetChildren,
                        tabIndex,
                    );
                    var tabsetWidthUpToCurrentTab = tabsetWidth + scrollLeft;
                    var isCurrentTabOutOfViewOnRightSide =
