...
var StyledContainer = (0, _attachThemeAttrs['default'])(_styledComponents['default'].span).attrs(
    function(props) {
    ...
    function(props) {
        return (
            ...
            '\n            color: '
                .concat(
                    props.palette.getContrastText(props.inverse),
                    ';\n            background-color: ',
                )
                .concat(props.inverse, ';\n        ')
        );
    },
    function(props) {
        return (
            ...
            '\n            color: '
                .concat(
                    props.palette.getContrastText(props.palette.warning.main),
                    ';\n            background-color: ',
                )
    ...
    function(props) {
        return (
            ...
            '\n            color: '
                .concat(
                    props.palette.getContrastText(props.palette.success.main),
                    ';\n            background-color: ',
                )
    ...
    function(props) {
        return (
            ...
            '\n            color: '
                .concat(
                    props.palette.getContrastText(props.palette.error.main),
                    ';\n            background-color: ',
                )
