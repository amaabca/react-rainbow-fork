...
var YearSelect = _react['default'].forwardRef(function(props, ref) {
    ...
    var handleYearChange = (0, _react.useCallback)(
        function(value) {
    ...
    var handleSelectFocus = (0, _react.useCallback)(
        function() {
            onFocus();
            setIsFocused(true);
        },
    ...
    var handleSelectBlur = (0, _react.useCallback)(
        function() {
            onBlur();
            setIsFocused(false);
        },
