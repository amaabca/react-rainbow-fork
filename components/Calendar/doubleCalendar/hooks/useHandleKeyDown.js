...
function useHandleKeyDown(
    ...
    var moveFocusedDay = (0, _useMoveFocusedDay['default'])(
        focusedDate,
        currentMonth,
        minDate,
        maxDate,
    ...
    var shouldUpdateCurrentMonth = (0, _react.useCallback)(
        function(value) {
            return (0, _shouldUpdateCurrentMonth['default'])(
                value,
                currentMonth,
                rightCalendarMonth,
            );
    ...
    var keyHandlerMap = (0, _react.useMemo)(
        function() {
            ...
            return (
                (_ref = {}),
                (0, _defineProperty2['default'])(_ref, _constants.UP_KEY, function() {
                ...
                (0, _defineProperty2['default'])(_ref, _constants.PAGEDN_KEY, function() {
                    ...
                    return {
                        day: result.day,
                        month: shouldUpdateCurrentMonth(result.month)
                            ? rightCalendarMonth
                            : undefined,
                    };
                }),
    ...
    var keyHandlerMapAlt = (0, _react.useMemo)(
        function() {
            var _ref2;

            return (
                (_ref2 = {}),
                (0, _defineProperty2['default'])(_ref2, _constants.HOME_KEY, function() {
                    var result = moveFocusedDay(-focusedDate.getDay());
                    return {
                        day: result.day,
                        month: shouldUpdateCurrentMonth(result.day) ? result.month : undefined,
                ...
                (0, _defineProperty2['default'])(_ref2, _constants.PAGEUP_KEY, function() {
                    ...
                    return {
                        day: result.day,
                        month: (0, _helpers.isSameMonth)(result.month, rightCalendarMonth)
                            ? (0, _helpers.addMonths)(result.month, -1)
                            : result.month,
                    };
                }),
