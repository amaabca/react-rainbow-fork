...
function SingleCalendarHeader(props) {
    ...
    var handlePrevMonthClick = (0, _react.useCallback)(
        function() {
            onPrevMonthClick();
            updateFocusedItem(0);
        },
    ...
    var handleNextMonthClick = (0, _react.useCallback)(
        function() {
            onNextMonthClick();
            updateFocusedItem(1);
        },
    ...
    var handleYearSelectClick = (0, _react.useCallback)(
        function() {
            updateFocusedItem(2);
        },
        [updateFocusedItem],
    ...
    return _react['default'].createElement(
        _controlsContainer['default'],
        {
            onKeyDown: handleKeyDown,
        },
        _react['default'].createElement(
            _monthContainer['default'],
            null,
