...
var Chart = (function(_Component) {
    ...
    function Chart(props) {
        ...
        _this.datasets = {};
        _this.registerDataset = _this.registerDataset.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.unregisterDataset = _this.unregisterDataset.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.updateDataset = _this.updateDataset.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        return _this;
    }
    ...
    (0, _createClass2['default'])(Chart, [
        ...
        },
        {
            ...
            value: function updateChart() {
                ...
                this.chartInstance.options = (0, _resolveOptions['default'])(
                    _objectSpread(
                        {
                            type: type,
                        },
        ...
        },
        {
            ...
            value: function renderChart() {
                ...
                var _this$props2 = this.props,
                    ...
                    conditions = (0, _objectWithoutProperties2['default'])(
                        _this$props2,
                        _excluded2,
                    );
                ...
                this.chartInstance = new _chart['default'](node, {
                    ...
                    options: (0, _resolveOptions['default'])(
                        _objectSpread(
                            {
                                type: type,
                                plugins: plugins,
