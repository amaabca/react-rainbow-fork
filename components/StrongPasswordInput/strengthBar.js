...
function StrengthBar(props) {
    ...
    return _react['default'].createElement(
        _styled.StyledStrenghtBar,
        null,
        _react['default'].createElement(_styled.StyledStateBar, {
...
StrengthBar.propTypes = {
    ...
    passwordStateLabels: _propTypes['default'].shape({
        weak: _propTypes['default'].oneOfType([
            _propTypes['default'].string,
            _propTypes['default'].node,
        ]),
        average: _propTypes['default'].oneOfType([
            _propTypes['default'].string,
            _propTypes['default'].node,
        ]),
        strong: _propTypes['default'].oneOfType([
            _propTypes['default'].string,
            _propTypes['default'].node,
        ]),
    }),
