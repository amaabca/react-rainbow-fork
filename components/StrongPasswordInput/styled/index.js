...
var StyledStrenghtBar = _styledComponents['default'].div(
    _templateObject2 ||
...
var StyledStateBar = (0, _attachThemeAttrs['default'])(_styledComponents['default'].div)(
    _templateObject3 ||
    ...
    function(props) {
        return (
            ...
            '\n            background-color: '
                .concat(
                    (0, _lighten['default'])(props.palette.warning.main),
                    ';\n\n            ::before {\n                width: 66%;\n                background-color: ',
                )
                .concat(props.palette.warning.main, '\n            }\n        ')
        );
    },
    function(props) {
        return (
...
var StyledStateLabel = (0, _attachThemeAttrs['default'])(_styledComponents['default'].span)(
    _templateObject4 ||
