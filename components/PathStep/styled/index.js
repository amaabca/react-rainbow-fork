...
var StyledStepItem = (0, _attachThemeAttrs['default'])(_styledComponents['default'].button)(
    _templateObject ||
    ...
    function(props) {
        return (
            props.isSelected &&
            '\n        background: '
                .concat(getBackgroundgColor(props), ';\n        color: ')
                .concat(
                    props.palette.getContrastText(getBackgroundgColor(props)),
                    ';\n        border-right: 2px solid ',
                )
                .concat(getBackgroundgColor(props), ';\n        box-shadow: ')
