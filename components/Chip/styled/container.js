...
var StyledContainer = (0, _attachThemeAttrs['default'])(_styledComponents['default'].span)(
    ...
    function(props) {
        return (
            ...
            '\n            background-color: '
                ...
                .concat(props.palette.text.label, ';\n        ')
        );
    },
    function(props) {
        return (
    ...
    function(props) {
        return (
            ...
            '\n            background-color: '
                .concat(props.palette[props.variant].main, ';\n            border: 1px solid ')
                .concat(props.palette[props.variant].main, ';\n            color: ')
                .concat(
                    props.palette.getContrastText(props.palette[props.variant].main),
                    ';\n        ',
                )
        );
    },
    function(props) {
        return (
            ...
            '\n                font-size: '
                ...
                .concat(_paddings.PADDING_MEDIUM, ';\n            ')
        );
    },
    function(props) {
        return (
            ...
            '\n                font-size: '
                ...
                .concat(_paddings.PADDING_X_SMALL, ';\n            ')
        );
    },
    function(props) {
        return (
