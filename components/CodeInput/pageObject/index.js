...
var PageCodeInput = (function() {
    ...
    (0, _createClass2['default'])(PageCodeInput, [
        ...
        },
        {
            ...
            value: (function() {
                var _clickInputAtIndex = (0, _asyncToGenerator2['default'])(
                    _regenerator['default'].mark(function _callee3(inputIndex) {
                        var input;
                        return _regenerator['default'].wrap(
        ...
        },
        {
            key: 'getFocusedIndex',
            value: (function() {
                var _getFocusedIndex = (0, _asyncToGenerator2['default'])(
        ...
        },
        {
            key: 'getFocusedValue',
            value: (function() {
                var _getFocusedValue = (0, _asyncToGenerator2['default'])(
        ...
        },
        {
            ...
            value: (function() {
                var _getInputValueAtIndex = (0, _asyncToGenerator2['default'])(
                    _regenerator['default'].mark(function _callee6(inputIndex) {
                        var input;
                        return _regenerator['default'].wrap(
        ...
        },
        {
            key: 'getFocusedInput',
            value: (function() {
                var _getFocusedInput = (0, _asyncToGenerator2['default'])(
                                                    ...
                                                    (function() {
                                                        ...
                                                        _asyncToGenerator2['default'])(
                                                            _regenerator['default'].mark(
                                                                function _callee7(input) {
                                                                    return _regenerator[
                                                                        'default'
                                                                    ].wrap(function _callee7$(
                                                                        _context7,
                                                                    ) {
                                                                        while (1) {
                                                                            switch (
        ...
        },
        {
            key: 'getInputAtIndex',
            value: (function() {
                var _getInputAtIndex = (0, _asyncToGenerator2['default'])(
                    _regenerator['default'].mark(function _callee9(inputIndex) {
                        var input;
                        return _regenerator['default'].wrap(
