...
var StyledItemsContainer = _styledComponents['default'].div(
    _templateObject2 ||
        (_templateObject2 = (0, _taggedTemplateLiteral2['default'])(['\n    align-self: ', ';\n'])),
    function(props) {
        return (
            _labelText.labelAlignmentMap[props.labelAlignment] ||
            _labelText.labelAlignmentMap.center
        );
    },
);

exports.StyledItemsContainer = StyledItemsContainer;
var StyledLabel = (0, _styledComponents['default'])(_label['default'])(
    _templateObject3 ||
...
var StyledStarContainer = (0, _attachThemeAttrs['default'])(_styledComponents['default'].span)(
    _templateObject4 ||
...
var StyledStarInput = (0, _attachThemeAttrs['default'])(_styledComponents['default'].input)(
    _templateObject5 ||
