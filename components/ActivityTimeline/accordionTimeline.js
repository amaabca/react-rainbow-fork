...
var _isChildRegistered = _interopRequireDefault(
    require('../InternalDropdown/helpers/isChildRegistered'),
);

var _insertChildOrderly = _interopRequireDefault(
    require('../InternalDropdown/helpers/insertChildOrderly'),
);
...
function AccordionTimeline(props) {
    ...
    var privateRegisterMarker = (0, _react.useCallback)(function(stepRef, stepProps) {
        if ((0, _isChildRegistered['default'])(stepProps.name, registeredTimelineMarkers.current))
            return;

        var _getChildTimelineMark = (0, _helpers.getChildTimelineMarkersNodes)(
                containerRef.current,
            ),
            _getChildTimelineMark2 = (0, _toArray2['default'])(_getChildTimelineMark),
            nodes = _getChildTimelineMark2.slice(0);

        var newStepsList = (0, _insertChildOrderly['default'])(
    ...
    var privateUnregisterMarker = (0, _react.useCallback)(function(stepRef, stepName) {
        if (!(0, _isChildRegistered['default'])(stepName, registeredTimelineMarkers.current))
            return;
        registeredTimelineMarkers.current = registeredTimelineMarkers.current.filter(function(
            step,
        ) {
            return step.name !== stepName;
        });
    }, []);
    var privateOnToggleMarker = (0, _react.useCallback)(
        function(_ref) {
...
AccordionTimeline.propTypes = {
    ...
    activeSectionNames: _propTypes['default'].oneOfType([
