...
var _findExpandableNodesAtLevel = _interopRequireDefault(
    require('../helpers/findExpandableNodesAtLevel'),
);
...
function useKeyNavigation(_ref) {
    ...
    var keyHandlerMap = (0, _react.useMemo)(
        function() {
            var _ref4;

            return (
                (_ref4 = {}),
                (0, _defineProperty2['default'])(_ref4, _constants.UP_KEY, function(_ref2) {
                    var name = _ref2.name;
                    var nextFocusedNode = (0, _getNextFocusedNode['default'])(
                        visibleNodes,
                        name,
                        -1,
                    );
    ...
    var processPrintableCharacter = (0, _react.useCallback)(
        function(_char) {
            if (_char === '*') {
                ...
                if (currentNode) {
                    var expandableNodes = (0, _findExpandableNodesAtLevel['default'])(
                        visibleNodes,
                        currentNode.level,
                    );
                ...
                var nextNode = (0, _findNodeByFirstLetter['default'])(
                    visibleNodes,
                    _char,
                    currentIndx,
                );
    ...
    var keyDownHandler = (0, _react.useCallback)(
        function(event, childProps) {
            var key = event.key,
    ...
    var setFocus = (0, _react.useCallback)(
        function(event, node) {
    ...
    var clearFocus = (0, _react.useCallback)(
        function(event, node) {
            if (event.target.id === event.currentTarget.id) {
