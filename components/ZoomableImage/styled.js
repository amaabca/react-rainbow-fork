...
var StyledImage = _styledComponents['default'].img(
    _templateObject ||
...
var StyledImageContainer = _styledComponents['default'].div(
    _templateObject2 ||
...
var StyledCenteredImage = _styledComponents['default'].img(
    _templateObject4 ||
    ...
    function(props) {
        return (
            ...
            '\n        transform: translate3d('
                .concat(props.transform.translateX, 'px, ')
                .concat(props.transform.translateY, 'px, 0px) scale(')
                .concat(props.transform.scale, ');\n        ')
        );
    },
);
