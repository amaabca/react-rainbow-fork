...
var StyledDropzone = (0, _attachThemeAttrs['default'])(_styledComponents['default'].div)(
    _templateObject2 ||
    ...
    function(props) {
        return (
            ...
            '\n        color: '
                ...
                .concat(props.palette.error.main, ';\n        background-color: ')
                .concat(
                    (0, _replaceAlpha['default'])(props.palette.error.main, 0.1),
                    ';\n\n        ',
                )
                .concat(
                    props.hasFocus &&
    ...
    function(props) {
        return (
            ...
            '\n        color: '
                .concat(props.palette.brand.main, ';\n        background-color: ')
                .concat(
                    (0, _replaceAlpha['default'])(props.palette.brand.main, 0.05),
                    ';\n        border-color: ',
                )
                .concat(props.palette.brand.main, ';\n    ')
        );
...
var TruncatedText = _styledComponents['default'].span(
    _templateObject3 ||
...
var StyledBackdrop = (0, _attachThemeAttrs['default'])(_styledComponents['default'].div)(
    _templateObject4 ||
    ...
    function(props) {
        return (
            props.variant === 'multiline' &&
            '\n        flex-direction: column;\n        justify-content: center;\n        align-items: center;\n        text-align: center;\n        font-size: '
                .concat(_fontSizes.FONT_SIZE_TEXT_MEDIUM, ';\n        padding: ')
                .concat(
                    _paddings.PADDING_MEDIUM,
...
var StyledIconContainer = (0, _attachThemeAttrs['default'])(
    (0, _styledComponents['default'])(_iconContainer['default']),
)(
    _templateObject5 ||
