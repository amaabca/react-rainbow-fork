...
describe('<BadgeOverlay/>', function() {
    ...
    it('should not render when the children is not passed', function() {
        var component = (0, _enzyme.mount)(
            _react['default'].createElement(_['default'], defaultProps),
        );
    ...
    it('should render with right default props', function() {
        ...
        var component = (0, _enzyme.mount)(
            _react['default'].createElement(_['default'], defaultProps, children),
        );
        expect(component.find(_['default']).props()).toEqual(
            _objectSpread(
