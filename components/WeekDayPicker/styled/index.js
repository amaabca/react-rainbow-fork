...
var StyledInput = (0, _attachThemeAttrs['default'])(
    (0, _styledComponents['default'])(_hiddenElement['default']),
)(
    _templateObject3 ||
...
var StyledWeekDayContainer = _styledComponents['default'].span(
    _templateObject4 ||
...
var StyledWeekDayLabel = (0, _attachThemeAttrs['default'])(
    _styledComponents['default'].label,
    ...
    function(props) {
        return (
            props.isChecked &&
            '\n        color: '
                .concat(props.activeColor, ';\n        background-color: ')
                .concat(props.activeBackground, ';\n        border: 1px solid ')
                .concat(
    ...
    function(props) {
        return (
            props.readOnly &&
            '\n        &:hover {\n            color: '
                .concat(props.defaultColor, ';\n            background-color: ')
                .concat(props.defaultBackground, ';\n            border: 1px solid ')
