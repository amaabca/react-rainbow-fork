...
var PageAvatarMenu = (function() {
    function PageAvatarMenu(rootElement) {
        ...
        this.primitiveMenu = new PagePrimitiveMenu(
            ''.concat(rootElement, ' button[data-id="avatar-menu-button"]'),
        );
    }
    ...
    (0, _createClass2['default'])(PageAvatarMenu, [
                                    ...
                                    switch ((_context.prev = _context.next)) {
                                        case 0:
                                            return _context.abrupt(
                                                'return',
                                                this.primitiveMenu.getItem(itemPosition),
                                            );
                                    ...
                                    switch ((_context3.prev = _context3.next)) {
                                        case 0:
                                            return _context3.abrupt(
                                                'return',
                                                this.primitiveMenu.isDropdownOpen(),
                                            );
        ...
        },
        {
            key: 'hasFocusButton',
            value: (function() {
                var _hasFocusButton = (0, _asyncToGenerator2['default'])(
                                    ...
                                    switch ((_context4.prev = _context4.next)) {
                                        case 0:
                                            return _context4.abrupt(
                                                'return',
                                                this.primitiveMenu.hasFocusTrigger(),
                                            );
