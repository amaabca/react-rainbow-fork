...
function _isPointWithinRect() {
    _isPointWithinRect = (0, _asyncToGenerator2['default'])(
        _regenerator['default'].mark(function _callee10(point, rect) {
...
var PageOption = (function() {
    ...
    (0, _createClass2['default'])(PageOption, [
        ...
        },
        {
            key: 'hover',
            value: (function() {
                var _hover = (0, _asyncToGenerator2['default'])(
        ...
        },
        {
            key: 'isVisible',
            value: (function() {
                var _isVisible = (0, _asyncToGenerator2['default'])(
        ...
        },
        {
            ...
            value: (function() {
                var _waitUntilIsVisible = (0, _asyncToGenerator2['default'])(
        ...
        },
        {
            key: 'scrollIntoView',
            value: (function() {
                var _scrollIntoView = (0, _asyncToGenerator2['default'])(
