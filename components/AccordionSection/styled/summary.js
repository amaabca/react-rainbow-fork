...
var StyledSummary = (0, _attachThemeAttrs['default'])(_styledComponents['default'].button)(
    _templateObject ||
    ...
    function(props) {
        return (
            ...
            '\n        \n        background-color: '
                .concat(
                    (0, _color.replaceAlpha)(props.palette.error.main, 0.1),
                    ';\n        border-color: ',
                )
                .concat(
                    (0, _color.replaceAlpha)(props.palette.error.main, 0.3),
                    ';\n\n        &:hover {\n            background-color: ',
                )
                .concat(
                    (0, _color.replaceAlpha)(props.palette.error.main, 0.2),
                    ';\n        }\n\n        &:focus {\n            outline: 0;\n            box-shadow: ',
                )
