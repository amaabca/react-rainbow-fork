...
describe('<Drawer />', function() {
    ...
    it(
        'should fire an event when the drawer is opened',
        (function() {
    ...
    it(
        'should call enableBodyScroll when drawer is closed',
        (function() {
                        ...
                        while (1) {
                            switch ((_context2.prev = _context2.next)) {
                                case 0:
                                    ...
                                    setTimeout(function() {
                                        expect(
                                            _scrollController.enableBodyScroll,
                                        ).toHaveBeenCalledWith(expect.any(Node));
                                        done();
                                    }, 300);
