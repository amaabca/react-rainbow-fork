...
var StyledContainer = (0, _attachThemeAttrs['default'])(_styledComponents['default'].section).attrs(
    function(props) {
    ...
    function(props) {
        return (
            ...
            '\n            animation: drawer-slide-'
                .concat(props.slideFrom, '-out 0.2s linear;\n            transform:  ')
                .concat(
                    props.slideFrom === 'left' ? 'translateX(-100%)' : 'translateX(100%)',
                    ';\n            opacity: 0;\n        ',
                )
        );
    },
