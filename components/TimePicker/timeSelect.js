...
var _verticalButtonsContainer = _interopRequireDefault(
    require('./styled/verticalButtonsContainer'),
);
...
var TimeSelect = (function(_Component) {
    ...
    function TimeSelect(props) {
        ...
        _this.handleChangeHour = _this.handleChangeHour.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleFocusHour = _this.handleFocusHour.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleBlurHour = _this.handleBlurHour.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleChangeMinutes = _this.handleChangeMinutes.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleFocusMinutes = _this.handleFocusMinutes.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleClickAmPm = _this.handleClickAmPm.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleAmPmChange = _this.handleAmPmChange.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.hanldeFocusAmPm = _this.hanldeFocusAmPm.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleKeyDown = _this.handleKeyDown.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.incrementHandler = _this.incrementHandler.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.decrementHandler = _this.decrementHandler.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleButtonsFocus = _this.handleButtonsFocus.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleChangeTime = _this.handleChangeTime.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleButtonsDown = _this.handleButtonsDown.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleClickOutside = _this.handleClickOutside.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
    ...
    (0, _createClass2['default'])(TimeSelect, [
        {
            ...
            value: function componentDidMount() {
                this.outsideClick.startListening(
        ...
        },
        {
            ...
            value: function handleChangeHour(event) {
                ...
                if ((0, _isNumber['default'])(value)) {
                    ...
                    var shouldNotFocusNextInput = !hour24
        ...
        },
        {
            ...
            value: function incrementHour() {
                ...
                this.setState({
                    hour: (0, _normalizeHour['default'])(
                        (0, _getNextHour['default'])(hourValue, hour24),
                        hour24,
                    ),
                });
            },
        },
        {
            ...
            value: function decrementHour() {
                ...
                this.setState({
                    hour: (0, _normalizeHour['default'])(
                        (0, _getPrevHour['default'])(hourValue, hour24),
                        hour24,
                    ),
                });
            },
        },
        {
            ...
            value: function incrementMinutes() {
                ...
                this.setState({
                    minutes: (0, _normalizeMinutes['default'])(
                        (0, _getNextMinute['default'])(minutesValue),
                    ),
                });
            },
        },
        {
            ...
            value: function decrementMinutes() {
                ...
                this.setState({
                    minutes: (0, _normalizeMinutes['default'])(
                        (0, _getPrevMinute['default'])(minutesValue),
                    ),
                });
            },
        },
            ...
            value: function render() {
                ...
                return _react['default'].createElement(
                    ...
                    _react['default'].createElement(
                        ...
                        _react['default'].createElement(_dots['default'], null, ':'),
                        _react['default'].createElement(_selectValue['default'], {
                            'aria-label': 'minutes',
                            onDrop: preventDefault,
                            onPaste: preventDefault,
                        ...
                        _react['default'].createElement(
                            _verticalButtonsContainer['default'],
                            null,
...
TimeSelect.propTypes = {
    ...
    cancelLabel: _propTypes['default'].oneOfType([
        _propTypes['default'].string,
        _propTypes['default'].node,
    ]),
    okLabel: _propTypes['default'].oneOfType([
        _propTypes['default'].string,
        _propTypes['default'].node,
    ]),
