...
var Checkbox = (0, _attachThemeAttrs['default'])(
    ...
    _margins.MARGIN_SMALL,
    getColor,
    function(props) {
        return props.error
            ? flash((0, _color.replaceAlpha)(props.palette.error.main, 0.5))
            : flash((0, _color.replaceAlpha)(props.palette.brand.main, 0.5));
    },
    getColor,
    getColor,
    getShadow,
