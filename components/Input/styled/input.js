...
var Input = (0, _attachThemeAttrs['default'])(_styledComponents['default'].input)(
    _templateObject ||
    ...
    function(props) {
        return (
            hasLeftIcon(props) &&
            '\n        padding-left: 2.35rem;\n        padding-right: 1rem;\n\n        &:focus,\n        &:active {\n            padding-left: '
                .concat(props.isBare || props.error ? '2.35rem' : '2.2875rem', ';\n            ')
                .concat(
    ...
    function(props) {
        return (
            hasRightIcon(props) &&
            '\n        padding-left: 1rem;\n        padding-right: 2.35rem;\n\n        &:focus,\n        &:active {\n            padding-right: '
                .concat(props.isBare ? '2.35rem' : '2.2875rem', ';\n            ')
                .concat(
