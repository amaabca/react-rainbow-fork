    ...
    (0, _createClass2['default'])(PageCarouselCard, [
        {
            ...
            value: (function() {
                var _getIndicatorItem = (0, _asyncToGenerator2['default'])(
        ...
        },
        {
            key: 'getImageItem',
            value: (function() {
                var _getImageItem = (0, _asyncToGenerator2['default'])(
                    _regenerator['default'].mark(function _callee2(itemPosition) {
                        var items;
                        return _regenerator['default'].wrap(
                                    ...
                                    switch ((_context2.prev = _context2.next)) {
                                        ...
                                        case 2:
                                            ...
                                            return _context2.abrupt(
                                                'return',
                                                new PageCarouselImage(
                                                    ''
                                                        .concat(
                                                            this.rootElement,
                                                            ' li[role="tabpanel"]:nth-child(',
                                                        )
                                                        .concat(itemPosition + 1, ')'),
                                                ),
                                            );
