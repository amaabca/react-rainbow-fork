...
function DateTimePickerModal(props) {
    ...
    (0, _react.useEffect)(
        function() {
            var currentDateTime = new Date(
                ''.concat((0, _extractDate['default'])(date), ' ').concat(time),
            );
            setModalTitle(
                (0, _formatDateTime['default'])(currentDateTime, formatStyle, locale, hour24),
            );
        },
    ...
    var handleChange = function handleChange(selectedTime) {
        var currentValue = new Date(
            ''.concat((0, _extractDate['default'])(date), ' ').concat(selectedTime),
        );
    ...
    return _react['default'].createElement(
        ...
        _react['default'].createElement(
            _header['default'],
            null,
            _react['default'].createElement(_title['default'], null, modalTitle),
        ),
        _react['default'].createElement(
            _responsiveContainer['default'],
            null,
