...
var CurrencyInput = (0, _react.forwardRef)(function(props, ref) {
    ...
    var currentValue = focused
        ? normalizedValue
        : (0, _helpers.formatCurrency)({
              value: value,
              locale: locale,
              options: options,
          });
    ...
    var handleChange = function handleChange(event) {
        ...
        if (
            (0, _helpers.isValidStringNumber)(cleanValue) &&
            normalizeNewValue !== normalizedValue
        ) {
            onChange(cleanValue);

            var _diffOfChar =
                (0, _helpers.countCharacters)(normalizeNewValue, groupSeparator) -
                (0, _helpers.countCharacters)(normalizedValue, groupSeparator);
