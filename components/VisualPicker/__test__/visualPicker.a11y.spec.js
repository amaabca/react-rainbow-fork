...
describe('<VisualPicker/>', function() {
                            ...
                            case 0:
                                ...
                                html = _server['default'].renderToString(
                                    _react['default'].createElement(
                                        ...
                                        _react['default'].createElement(
                                            _VisualPickerOption['default'],
                                            {
                                                name: 'option-1',
                                                footer: _react['default'].createElement(
                                                    _VisualPickerOptionFooter['default'],
                                                    {
                                                        label: 'Rainbow Basic',
                                                        description:
                                                            'Complete service for teams of any size.',
                                                    },
                                                ),
                                            },
                                            _react['default'].createElement(
                                            ...
                                            _VisualPickerOption['default'],
                                            {
                                                ...
                                                footer: _react['default'].createElement(
                                                    _VisualPickerOptionFooter['default'],
                                                    {
                                                        label: 'Rainbow Basic',
                                                        description:
                                                            'Everything you need to take support.',
                                                    },
                                                ),
                                            },
                                            _react['default'].createElement(
    ...
    it(
        'should be accessible when multiple option are selected',
        (0, _asyncToGenerator2['default'])(
    ...
    it(
        'should be accessible when label or description is not passed on VisualPickerOptionFooter',
        (0, _asyncToGenerator2['default'])(
