...
function useArrowKeyNav(_ref) {
    ...
    var focusChild = (0, _react.useCallback)(
        function(index) {
    ...
    var focusMatchedItem = (0, _react.useCallback)(
    ...
    var clearFocusedChild = (0, _react.useCallback)(
        function() {
    ...
    var keyHandlerMap = (0, _react.useMemo)(
        function() {
            ...
            return (
                (_ref2 = {}),
                (0, _defineProperty2['default'])(_ref2, _constants.UP_KEY, function() {
                    var nextFocusedChildIndex =
    ...
    var handleKeyPress = (0, _react.useCallback)(
        function(event) {
