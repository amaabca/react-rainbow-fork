    ...
    (0, _createClass2['default'])(PageTable, [
        {
            key: 'selectAllRows',
            value: (function() {
                var _selectAllRows = (0, _asyncToGenerator2['default'])(
        ...
        },
        {
            key: 'deselectAllRows',
            value: (function() {
                var _deselectAllRows = (0, _asyncToGenerator2['default'])(
        ...
        },
        {
            key: 'getRow',
            value: (function() {
                var _getRow = (0, _asyncToGenerator2['default'])(
                    _regenerator['default'].mark(function _callee3(rowPosition) {
                        var rows;
                        return _regenerator['default'].wrap(
                                ...
                                while (1) {
                                    switch ((_context3.prev = _context3.next)) {
                                        case 0:
                                            _context3.next = 2;
                                            return $(this.rootElement).$$(
                                                'tbody > tr[data-id="table_body-row"]',
                                            );
                                            ...
                                            return _context3.abrupt(
                                                ...
                                                new PageTableRow(
                                                    ''
                                                        .concat(
                                                            this.rootElement,
                                                            ' tr[data-id="table_body-row"]:nth-child(',
                                                        )
                                                        .concat(rowPosition + 1, ')'),
                                                ),
                                            );
        ...
        },
        {
            ...
            value: (function() {
                var _waitUntilDataIsLoaded = (0, _asyncToGenerator2['default'])(
