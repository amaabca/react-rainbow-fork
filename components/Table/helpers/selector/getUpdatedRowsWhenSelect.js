...
function getUpdatedRowsWhenSelect() {
    ...
    if (maxRowSelection > 1) {
        ...
        var rowsWithSelection = rows.map(function(row, index) {
            var currentSelectionLength = (0, _getCurrentSelectionLength['default'])(
                selectedRowsKeys,
            );
        ...
        return rowsWithSelection.map(function(row) {
            var maxSelectionReached =
                (0, _getCurrentSelectionLength['default'])(selectedRowsKeys) === maxRowSelection;
