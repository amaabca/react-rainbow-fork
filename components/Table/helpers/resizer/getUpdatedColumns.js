...
var _getExpectedFlexibleColumnWidth = _interopRequireDefault(
    require('./getExpectedFlexibleColumnWidth'),
);
...
function getUpdatedColumns(params) {
    ...
    var expectedFlexibleColumnWidth = (0, _getExpectedFlexibleColumnWidth['default'])(
        widthsMeta,
        expectedTableWidth,
    );
    return columns.map(function(column) {
        return _objectSpread(
            ...
            {
                computedWidth:
                    (0, _getColumnWidthFromDef['default'])(column) || expectedFlexibleColumnWidth,
            },
        );
    });
}
