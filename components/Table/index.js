...
var Table = (function(_Component) {
    ...
    function Table(props) {
        ...
        _this.selectedRowsKeys = (0, _selector.getSelectedRowKeysFromSelectedRows)(
            selectedRows,
            _this.indexes,
        );
        ...
        _this.updateColumnsAndTableWidth = _this.updateColumnsAndTableWidth.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleSelectRow = _this.handleSelectRow.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleDeselectRow = _this.handleDeselectRow.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleSelectAllRows = _this.handleSelectAllRows.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleDeselectAllRows = _this.handleDeselectAllRows.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
    ...
    (0, _createClass2['default'])(Table, [
        {
            ...
            value: function componentDidMount() {
                this.widthObserver = new _ResizeSensor['default'](
                    this.resizeTarget.current,
                    (0, _debounce['default'])(this.updateColumnsAndTableWidth, 200),
                );
                this.updateRows();
            ...
            value: function componentDidUpdate(prevProps) {
                ...
                if (isNotSameSelectedRows) {
                    ...
                    if (selectedRowsKeysLength !== selectedRows.length) {
                        this.selectedRowsKeys = (0, _selector.getSelectedRowKeysFromSelectedRows)(
                            selectedRows,
                            this.indexes,
                        );
        ...
        },
        {
            ...
            value: function handleSort(event, field, sortDirection) {
                ...
                var nextSortDirection = (0, _sort.getNextSortDirection)(
                    field,
                    sortedBy,
                    sortDirection,
                );
                    ...
                    return _react['default'].createElement(
                        ...
                        _react['default'].createElement(
                            ...
                            _react['default'].createElement(
                                ...
                                null,
                                _react['default'].createElement(
                                    _scrollableX['default'],
                                    {
                                        ref: this.tableContainerRef,
                                    },
                                    _react['default'].createElement(
                                        _scrollableY['default'],
                                        {
                                            isEmpty: isEmpty,
                                            isLoading: isLoading,
                                                ...
                                                _react['default'].createElement(
                                                    ...
                                                    _react['default'].createElement(
                                                        _head['default'],
                                                        {
                                                            ...
                                                            onSelectAllRows: this
                                                                .handleSelectAllRows,
                                                            onDeselectAllRows: this
...
Table.propTypes = {
    ...
    minColumnWidth: _propTypes['default'].oneOfType([
        _propTypes['default'].number,
        _propTypes['default'].string,
    ]),
    maxColumnWidth: _propTypes['default'].oneOfType([
        _propTypes['default'].number,
        _propTypes['default'].string,
    ]),
    ...
    maxRowSelection: _propTypes['default'].oneOfType([
        _propTypes['default'].number,
        _propTypes['default'].string,
    ]),
