...
var StyledRow = (0, _attachThemeAttrs['default'])(_styledComponents['default'].tr)(
    _templateObject ||
    ...
    function(props) {
        return (
            ...
            '\n        box-shadow: '
                ...
                .concat(
                    (0, _color.replaceAlpha)(props.palette.action.hover, 0.4),
                    ';\n            box-shadow: ',
                )
    ...
    function(props) {
        return (
            ...
            '\n        background-color: '.concat(
                (0, _color.replaceAlpha)(props.palette.action.active, 0.4),
                ';\n        ',
            )
        );
    },
