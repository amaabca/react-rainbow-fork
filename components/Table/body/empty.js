...
function Empty(props) {
    ...
    return _react['default'].createElement(
        ...
        _react['default'].createElement(
            ...
            _react['default'].createElement(
                _emptyContainer['default'],
                null,
                _react['default'].createElement(_emptyIcon['default'], null, emptyIcon),
                _react['default'].createElement(_emptyTitle['default'], null, emptyTitle),
                _react['default'].createElement(
                    _emptyDescription['default'],
                    null,
                    emptyDescription,
                ),
            ),
