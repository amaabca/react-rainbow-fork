...
var searchOptionsShape = _propTypes.PropTypes.shape({
    ...
    country: _propTypes.PropTypes.oneOfType([
        _propTypes.PropTypes.arrayOf(_propTypes.PropTypes.string),
        _propTypes.PropTypes.string,
    ]),
...
var predictionShape = _propTypes.PropTypes.shape({
    ...
    matched_substrings: _propTypes.PropTypes.arrayOf(
    ...
    structured_formatting: _propTypes.PropTypes.arrayOf(
        _propTypes.PropTypes.shape({
            main_text: _propTypes.PropTypes.string,
            main_text_matched_substrings: _propTypes.PropTypes.arrayOf(
                _propTypes.PropTypes.shape({
                    length: _propTypes.PropTypes.number,
                    offset: _propTypes.PropTypes.number,
                }),
    ...
    terms: _propTypes.PropTypes.arrayOf(
        _propTypes.PropTypes.shape({
            offset: _propTypes.PropTypes.number,
...
var placeDetailsShape = _propTypes.PropTypes.shape({
    address_components: _propTypes.PropTypes.arrayOf(
        _propTypes.PropTypes.shape({
    ...
    photos: _propTypes.PropTypes.arrayOf(
        _propTypes.PropTypes.shape({
    ...
    rating: _propTypes.PropTypes.number,
    reviews: _propTypes.PropTypes.arrayOf(
        _propTypes.PropTypes.shape({
            aspects: _propTypes.PropTypes.arrayOf(aspectsRating),
