...
var _poweredByGoogleContainer = _interopRequireDefault(
    require('./styled/poweredByGoogleContainer'),
);
    ...
    (0, _createClass2['default'])(PlacesLookupComponent, [
        ...
        },
        {
            ...
            value: function searchGooglePlaces(needle) {
                ...
                return new Promise(function(resolve, reject) {
                    _this4.autocompleteService.getPlacePredictions(
                        _objectSpread(
                            _objectSpread({}, searchParams),
                            {},
                            {
                                input: needle,
                            },
            ...
            value: function render() {
                ...
                return _react['default'].createElement(
                    ...
                    _react['default'].createElement(_Lookup['default'], {
                        ...
                        tabIndex: tabIndex,
                        disabled: disabled,
                        value: (0, _getFormattedValue['default'])(
                            value,
                            false,
                            _react['default'].createElement(_selectedLocationIcon['default'], null),
                        ),
                    ...
                    _react['default'].createElement(
                        ...
                        _react['default'].createElement(
                            _poweredByGoogleContainer['default'],
                            null,
                            _react['default'].createElement(_poweredByGoogleLogo['default'], null),
                        ),
                    ),
