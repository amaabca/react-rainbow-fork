...
function EmptyMessage(_ref) {
    ...
    return _react['default'].createElement(
        _styled.MessageContainer,
        {
            'data-id': 'internal-dropdown-empty-message',
        },
        _react['default'].createElement(_styled.StyledSearchIcon, null),
        _react['default'].createElement(_styled.MessageDescription, null, message),
