...
var preventDefaultKeys = ((_preventDefaultKeys = {}),
(0, _defineProperty2['default'])(_preventDefaultKeys, _constants.UP_KEY, true),
(0, _defineProperty2['default'])(_preventDefaultKeys, _constants.DOWN_KEY, true),
_preventDefaultKeys);
...
var InternalDropdown = (0, _react.forwardRef)(function(props, reference) {
    ...
    var showEmptyMessage =
        enableSearch && onSearch
            ? !isLoading && _react['default'].Children.count(children) === 0
            : !isLoading && (0, _isEmptyObject['default'])(activeChildrenMap);
    ...
    var registerChild = (0, _react.useCallback)(function(childRef, childProps) {
        ...
        var newChildren = (0, _insertChildOrderly['default'])(
    ...
    var hoverChild = (0, _react.useCallback)(function(event, name) {
        ...
        setActiveOptionIndex(
            activeChildren.current.findIndex(function(child) {
                return child.name === name;
            }),
        );
    }, []);
    ...
    var keyHandlerMap = ((_keyHandlerMap = {}),
    (0, _defineProperty2['default'])(_keyHandlerMap, _constants.UP_KEY, handleKeyUpPressed),
    (0, _defineProperty2['default'])(_keyHandlerMap, _constants.DOWN_KEY, handleKeyDownPressed),
    (0, _defineProperty2['default'])(_keyHandlerMap, _constants.ENTER_KEY, handleKeyEnterPressed),
    _keyHandlerMap);
    ...
    var handleSearch = function handleSearch(event) {
        ...
        if (onSearch) {
            ...
            setActiveChildrenMap(
                filteredOptions.reduce(function(acc, option) {
    ...
    return _react['default'].createElement(
        ...
        _react['default'].createElement(
            ...
            _react['default'].createElement(
                _styled.SearchContainer,
                {
                    isLoading: isLoading,
                },
                _react['default'].createElement(_styled.Icon, null),
                _react['default'].createElement(_styled.InputSearch, {
