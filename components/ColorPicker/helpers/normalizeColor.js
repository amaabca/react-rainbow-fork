...
function getRgba(value, isValidHex) {
    ...
    return (0, _color.rgbToRgba)(
        (0, _color.hsvToRgb)(
            (0, _color.recomposeColor)({
                type: 'hsv',
                values: value.hsv,
            }),
        ),
...
function normalizeColor(value) {
    ...
    var isValidRgba = (0, _color.isValidColor)(
        (0, _color.recomposeColor)({
            type: 'rgba',
            values: rgba,
        }),
    );
    var isValidHsv = (0, _color.isHsvColor)(
        (0, _color.recomposeColor)({
            type: 'hsv',
            values: hsv,
        }),
    ...
    var hsvColor = isValidHsv
        ? hsv
        : (0, _color.decomposeColor)((0, _color.rgbToHsv)(rgbaColor)).values;
    return {
        hex: hexColor,
