...
var PageMultiSelect = (function() {
    ...
    _createClass(PageMultiSelect, [
        ...
        },
        {
            key: 'clickTrigger',
            value: (function() {
                var _clickTrigger = _asyncToGenerator(
        ...
        },
        {
            key: 'hasTriggerFocus',
            value: (function() {
                var _hasTriggerFocus = _asyncToGenerator(
        ...
        },
        {
            key: 'hasInputFocus',
            value: (function() {
                var _hasInputFocus = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _getOption = _asyncToGenerator(
                    _regeneratorRuntime.mark(function _callee8(optionIndex) {
                        return _regeneratorRuntime.wrap(
