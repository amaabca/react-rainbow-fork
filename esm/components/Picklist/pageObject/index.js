    ...
    _createClass(PagePicklist, [
        {
            key: 'clickInput',
            value: (function() {
                var _clickInput = _asyncToGenerator(
        ...
        },
        {
            key: 'focusInput',
            value: (function() {
                var _focusInput = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _mouseLeaveScrollArrow = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _getOption = _asyncToGenerator(
                    _regeneratorRuntime.mark(function _callee13(optionIndex) {
                        return _regeneratorRuntime.wrap(
        ...
        },
        {
            key: 'clickSearch',
            value: (function() {
                var _clickSearch = _asyncToGenerator(
