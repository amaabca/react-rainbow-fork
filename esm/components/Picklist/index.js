...
function _positionResolver(opts, enableSearch) {
    ...
    return _objectSpread(
        _objectSpread({}, InternalOverlay.defaultPositionResolver(newOpts)),
        {},
        {
            width: trigger.width,
        },
...
var Picklist = (function(_Component) {
    ...
    function Picklist(props) {
        ...
        _defineProperty(_this$keyHandlerMap, ESCAPE_KEY, _this.closeAndFocusInput),
        _defineProperty(_this$keyHandlerMap, TAB_KEY, _this.closeAndFocusInput),
        _this$keyHandlerMap);
        return _this;
    }
