...
function SvgZambia(_ref) {
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement('path', {
                d:
                    'M29.565 10.435h-4.174a1.391 1.391 0 00-2.782 0h-4.174c0 .768.669 1.391 1.437 1.391h-.046c0 .769.623 1.391 1.391 1.391 0 .769.623 1.392 1.392 1.392h2.782c.769 0 1.392-.623 1.392-1.392.768 0 1.39-.622 1.39-1.39h-.045c.768 0 1.437-.624 1.437-1.392z',
                fill: '#FF9811',
            }),
        ),
    );
