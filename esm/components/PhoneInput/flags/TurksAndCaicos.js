...
function SvgTurksAndCaicos(_ref) {
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement('path', {
                d:
                    'M22.26 11.13c0 .769-.622 2.783-1.39 2.783-.769 0-1.392-2.014-1.392-2.783 0-.768 1.392-1.39 1.392-1.39s1.39.622 1.39 1.39z',
                fill: '#FF9811',
            }),
            React.createElement('path', {
                d:
                    'M25.953 12.646c.224-.548.399-1.349.399-1.747 0-.64-.835-1.16-.835-1.16s-.835.52-.835 1.16c0 .398.175 1.199.4 1.747l-.483 1.088a2.431 2.431 0 001.836 0l-.482-1.088z',
                fill: '#A2001D',
            }),
            React.createElement('path', {
                d:
                    'M21.913 16s-.696 1.391-.696 2.783h3.479C24.696 17.39 24 16 24 16l-1.044-.696-1.043.696z',
                fill: '#6DA544',
            }),
            React.createElement('path', {
