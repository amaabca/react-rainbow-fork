...
function SvgFiji(_ref) {
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement('path', {
                d:
                    'M18.087 10.435V16c0 3.727 4.87 4.87 4.87 4.87s4.87-1.143 4.87-4.87v-5.565l-4.87-1.392-4.87 1.392z',
                fill: '#F3F3F3',
            }),
            React.createElement('path', {
                d:
                    'M27.826 10.435V8.348h-9.74v2.087h4.175v4.174h-4.174V16h4.174v4.656c.42.149.695.214.695.214s.276-.065.696-.214V16h4.174v-1.391h-4.174v-4.174h4.174z',
                fill: '#D80027',
            }),
        ),
    );
