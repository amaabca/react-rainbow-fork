...
function SvgKosovo(_ref) {
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement('path', {
                d:
                    'M18.783 16.696L16 13.217l-1.391.696v1.391l-2.087 1.392H11.13v1.797a5.566 5.566 0 013.479 5.16H16V22.26l1.391-1.391 1.392 1.39 1.39-1.39v-1.392l1.392-2.087-2.782-.695z',
                fill: '#FFDA44',
            }),
        ),
    );
