...
function SvgBritishVirginIslands(_ref) {
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement('path', {
                d:
                    'M18.087 8.348V16c0 3.727 4.87 4.87 4.87 4.87s4.869-1.143 4.87-4.87V8.348h-9.74z',
                fill: '#6DA544',
            }),
            React.createElement(
                'g',
            ...
            React.createElement(
                ...
                React.createElement('path', {
                    d:
                        'M19.479 9.74h1.39v1.39h-1.39zM19.479 12.87h1.39v1.39h-1.39zM19.479 16h1.39v1.391h-1.39zM25.044 9.74h1.39v1.39h-1.39zM25.044 12.87h1.39v1.39h-1.39zM25.044 16h1.39v1.391h-1.39z',
                }),
            ),
        ),
    );
