    ...
    _createClass(PageTimePicker, [
        {
            key: 'clickTimeInput',
            value: (function() {
                var _clickTimeInput = _asyncToGenerator(
        ...
        },
        {
            key: 'clickUpButton',
            value: (function() {
                var _clickUpButton = _asyncToGenerator(
        ...
        },
        {
            key: 'clickDownButton',
            value: (function() {
                var _clickDownButton = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _clickCancelButton = _asyncToGenerator(
        ...
        },
        {
            key: 'clickOkButton',
            value: (function() {
                var _clickOkButton = _asyncToGenerator(
        ...
        },
        {
            key: 'getTimeValue',
            value: (function() {
                var _getTimeValue = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _hasFocusTimeInput = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _hasFocusHourInput = _asyncToGenerator(
        ...
        },
        {
            key: 'getHourValue',
            value: (function() {
                var _getHourValue = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _hasFocusMinutesInput = _asyncToGenerator(
        ...
        },
        {
            key: 'getMinutesValue',
            value: (function() {
                var _getMinutesValue = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _hasFocusAmPmSelect = _asyncToGenerator(
        ...
        },
        {
            key: 'isAmSelected',
            value: (function() {
                var _isAmSelected = _asyncToGenerator(
        ...
        },
        {
            key: 'isPmSelected',
            value: (function() {
                var _isPmSelected = _asyncToGenerator(
        ...
        },
        {
            key: 'setHourValue',
            value: (function() {
                var _setHourValue = _asyncToGenerator(
                    _regeneratorRuntime.mark(function _callee19(value) {
        ...
        },
        {
            key: 'setMinutesValue',
            value: (function() {
                var _setMinutesValue = _asyncToGenerator(
                    _regeneratorRuntime.mark(function _callee20(value) {
        ...
        },
        {
            key: 'waitUntilClose',
            value: (function() {
                var _waitUntilClose = _asyncToGenerator(
