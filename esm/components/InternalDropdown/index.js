...
_defineProperty(_preventDefaultKeys, UP_KEY, true),
_defineProperty(_preventDefaultKeys, DOWN_KEY, true),
_preventDefaultKeys);
...
var InternalDropdown = forwardRef(function(props, reference) {
    ...
    var registerChild = useCallback(function(childRef, childProps) {
        ...
        var newChildren = insertChildOrderly(
    ...
    _defineProperty(_keyHandlerMap, UP_KEY, handleKeyUpPressed),
    _defineProperty(_keyHandlerMap, DOWN_KEY, handleKeyDownPressed),
    _defineProperty(_keyHandlerMap, ENTER_KEY, handleKeyEnterPressed),
    _keyHandlerMap);
