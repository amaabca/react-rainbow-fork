...
var StyledStrenghtBar = styled.div(
    _templateObject2 ||
        (_templateObject2 = _taggedTemplateLiteral([
            '\n    display: flex;\n    flex-direction: row;\n',
        ])),
);
var StyledStateBar = attachThemeAttrs(styled.div)(
    _templateObject3 ||
    ...
    function(props) {
        return (
            ...
            '\n            background-color: '
                .concat(
                    lighten(props.palette.warning.main),
                    ';\n\n            ::before {\n                width: 66%;\n                background-color: ',
                )
...
var StyledStateLabel = attachThemeAttrs(styled.span)(
    _templateObject4 ||
...
var StyledHelpText = styled(HelpText)(
