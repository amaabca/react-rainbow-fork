...
var Tabset = (function(_Component) {
    ...
    function Tabset(props) {
        ...
        _defineProperty(_this$keyHandlerMap, RIGHT_KEY, function() {
        ...
        },
        {
            ...
            value: function scrollToSelectedTab(name) {
                ...
                if (isFirstTab) {
                    ...
                    var totalWidthUpToCurrentTab = getChildrenTotalWidthUpToClickedTab(
                        tabsetChildren,
                        tabIndex + 1,
                    );
                    var totalWidthUpToPrevTab = getChildrenTotalWidthUpToClickedTab(
                        tabsetChildren,
                        tabIndex,
                    );
