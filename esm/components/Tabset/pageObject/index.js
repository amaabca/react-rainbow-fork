...
var PageTabset = (function() {
    ...
    _createClass(PageTabset, [
        ...
        },
        {
            ...
            value: (function() {
                var _isButtonsVisible = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _isLeftButtonEnabled = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _isRightButtonEnabled = _asyncToGenerator(
        ...
        },
        {
            key: 'clickLeftButton',
            value: (function() {
                var _clickLeftButton = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _clickRightButton = _asyncToGenerator(
