...
var PageSingleCalendar = (function() {
    ...
    _createClass(PageSingleCalendar, [
        ...
        },
        {
            key: 'clickSelectYear',
            value: (function() {
                var _clickSelectYear = _asyncToGenerator(
        ...
        },
        {
            key: 'clickDay',
            value: (function() {
                var _clickDay = _asyncToGenerator(
                    _regeneratorRuntime.mark(function _callee4(day) {
                        var buttonEl;
                        return _regeneratorRuntime.wrap(
        ...
        },
        {
            ...
            value: (function() {
                var _getSelectedMonth = _asyncToGenerator(
        ...
        },
        {
            key: 'getSelectedYear',
            value: (function() {
                var _getSelectedYear = _asyncToGenerator(
        ...
        },
        {
            key: 'getSelectedDay',
            value: (function() {
                var _getSelectedDay = _asyncToGenerator(
        ...
        },
        {
            key: 'isDaySelected',
            value: (function() {
                var _isDaySelected = _asyncToGenerator(
        ...
        },
        {
            key: 'isDayEnabled',
            value: (function() {
                var _isDayEnabled = _asyncToGenerator(
                    _regeneratorRuntime.mark(function _callee9(day) {
                        var spanEl;
                        return _regeneratorRuntime.wrap(
        ...
        },
        {
            key: 'setYear',
            value: (function() {
                var _setYear = _asyncToGenerator(
        ...
        },
        {
            key: 'isDayFocused',
            value: (function() {
                var _isDayFocused = _asyncToGenerator(
                    _regeneratorRuntime.mark(function _callee11(day) {
                        var buttonEl;
                        return _regeneratorRuntime.wrap(
        ...
        },
        {
            ...
            value: (function() {
                var _isYearSelectFocused = _asyncToGenerator(
