    ...
    _createClass(PageWeekDayPicker, [
        {
            key: 'clickOn',
            value: (function() {
                var _clickOn = _asyncToGenerator(
                    _regeneratorRuntime.mark(function _callee(weekDay) {
                        var inputRef;
        ...
        },
        {
            key: 'getSelectedDays',
            value: (function() {
                var _getSelectedDays = _asyncToGenerator(
        ...
        },
        {
            key: 'getFocusedDay',
            value: (function() {
                var _getFocusedDay = _asyncToGenerator(
        ...
        },
        {
            key: 'getInput',
            value: (function() {
                var _getInput = _asyncToGenerator(
                    _regeneratorRuntime.mark(function _callee6(weekDay) {
                        var index, elem;
                        return _regeneratorRuntime.wrap(
        ...
        },
        {
            key: 'getInputRef',
            value: (function() {
                var _getInputRef = _asyncToGenerator(
                    _regeneratorRuntime.mark(function _callee7(weekDay) {
                        var index, elem;
                        return _regeneratorRuntime.wrap(
