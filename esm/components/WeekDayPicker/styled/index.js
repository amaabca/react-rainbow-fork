...
export var StyledFieldset = styled.fieldset(
    _templateObject ||
        (_templateObject = _taggedTemplateLiteral([
            '\n    line-height: 1.5rem;\n    margin: 0;\n    padding: 0;\n    border: 0;\n    box-sizing: border-box;\n    text-align: center;\n',
        ])),
);
export var StyledHelpText = styled(HelpText)(
    _templateObject2 ||
        (_templateObject2 = _taggedTemplateLiteral(['\n    text-align: center;\n'])),
);
export var StyledInput = attachThemeAttrs(styled(HiddenElement))(
    _templateObject3 ||
...
export var StyledWeekDayContainer = styled.span(
    _templateObject4 ||
