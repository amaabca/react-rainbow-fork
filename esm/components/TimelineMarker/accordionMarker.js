...
export default function AccordionTimelineMarker(props) {
    ...
    var resolveActiveNamesWhenMultiple = useCallback(
        function() {
    ...
    var resolveActiveNames = useCallback(
        function() {
            if (multiple) {
    ...
    var handleToggleMarker = useCallback(
        function() {
    ...
    var shouldRenderChildren = useMemo(
        function() {
        ...
        React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(StyledDatetime, null, datetime),
                ),
