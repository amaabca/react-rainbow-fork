...
var Header = React.forwardRef(function(props, ref) {
        ...
        return Array.from(Array(7), function(_value, index) {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(StyledWeekDay, null, formattedWeekDay(day)),
                    React.createElement(StyledNumberDay, null, formattedNumberDay(day)),
                ),
            );
        });
    }
    ...
    return React.createElement(
        ...
        React.createElement(StyledHours, null, timeZone),
        React.createElement(
            StyledDays,
            {
                ref: ref,
