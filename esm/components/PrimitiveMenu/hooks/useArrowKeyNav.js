...
export default function useArrowKeyNav(_ref) {
    ...
    var focusMatchedItem = useCallback(
    ...
    var clearFocusedChild = useCallback(
        function() {
            return setFocusedChildIndex(null);
        },
        [setFocusedChildIndex],
    );
    var keyHandlerMap = useMemo(
        function() {
            var _ref2;

            return (
                (_ref2 = {}),
                _defineProperty(_ref2, UP_KEY, function() {
    ...
    var processPrintableCharacter = useCallback(
        function(_char) {
    ...
    var handleKeyPress = useCallback(
        function(event) {
