...
export var StyledButton = attachThemeAttrs(styled.button)(
    _templateObject ||
...
export var StyledTooltip = attachThemeAttrs(styled.div)(
    _templateObject2 ||
...
export var StyledIconContainer = styled.span(
    _templateObject4 || (_templateObject4 = _taggedTemplateLiteral(['\n    margin-right: 8px;\n'])),
);
export var StyledText = attachThemeAttrs(styled.div)(
    _templateObject5 ||
