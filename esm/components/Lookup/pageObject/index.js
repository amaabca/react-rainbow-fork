...
var PageLookup = (function() {
    ...
    _createClass(PageLookup, [
        ...
        },
        {
            ...
            value: (function() {
                var _clickCloseButton = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _clickSelectedOptionInput = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _clickRemoveSelectedOptionButton = _asyncToGenerator(
        ...
        },
        {
            key: 'hasFocusInput',
            value: (function() {
                var _hasFocusInput = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _hasFocusSelectedOptionInput = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _hasFocusRemoveSelectedOptionButton = _asyncToGenerator(
        ...
        },
        {
            key: 'setQuery',
            value: (function() {
                var _setQuery = _asyncToGenerator(
                    _regeneratorRuntime.mark(function _callee9(value) {
                        return _regeneratorRuntime.wrap(
        ...
        },
        {
            key: 'clearQuery',
            value: (function() {
                var _clearQuery = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _getOptionsLength = _asyncToGenerator(
        ...
        },
        {
            key: 'getOption',
            value: (function() {
                var _getOption = _asyncToGenerator(
                    _regeneratorRuntime.mark(function _callee13(itemPosition) {
                        var items;
        ...
        },
        {
            ...
            value: (function() {
                var _getSelectedOptionLabel = _asyncToGenerator(
        ...
        },
        {
            key: 'isMenuOpen',
            value: (function() {
                var _isMenuOpen = _asyncToGenerator(
        ...
        },
        {
            key: 'isMenuEmpty',
            value: (function() {
                var _isMenuEmpty = _asyncToGenerator(
        ...
        },
        {
            key: 'waitUntilOpen',
            value: (function() {
                var _waitUntilOpen = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _hoverScrollUpArrow = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _mouseLeaveScrollUpArrow = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _hoverScrollDownArrow = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _mouseLeaveScrollDownArrow = _asyncToGenerator(
        ...
        },
        {
            key: 'arrowDownExists',
            value: (function() {
                var _arrowDownExists = _asyncToGenerator(
        ...
        },
        {
            key: 'arrowUpExists',
            value: (function() {
                var _arrowUpExists = _asyncToGenerator(
