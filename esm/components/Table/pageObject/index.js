    ...
    _createClass(PageTable, [
        {
            key: 'selectAllRows',
            value: (function() {
                var _selectAllRows = _asyncToGenerator(
        ...
        },
        {
            key: 'deselectAllRows',
            value: (function() {
                var _deselectAllRows = _asyncToGenerator(
        ...
        },
        {
            key: 'getRow',
            value: (function() {
                var _getRow = _asyncToGenerator(
                    _regeneratorRuntime.mark(function _callee3(rowPosition) {
                        var rows;
                        return _regeneratorRuntime.wrap(
        ...
        },
        {
            ...
            value: (function() {
                var _waitUntilDataIsLoaded = _asyncToGenerator(
