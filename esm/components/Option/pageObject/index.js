...
function _isPointWithinRect() {
    _isPointWithinRect = _asyncToGenerator(
        _regeneratorRuntime.mark(function _callee10(point, rect) {
...
var PageOption = (function() {
    ...
    _createClass(PageOption, [
        ...
        },
        {
            key: 'isActive',
            value: (function() {
                var _isActive = _asyncToGenerator(
        ...
        },
        {
            key: 'isSelected',
            value: (function() {
                var _isSelected = _asyncToGenerator(
        ...
        },
        {
            key: 'isVisible',
            value: (function() {
                var _isVisible = _asyncToGenerator(
        ...
        },
        {
            ...
            value: (function() {
                var _waitUntilIsVisible = _asyncToGenerator(
        ...
        },
        {
            key: 'scrollIntoView',
            value: (function() {
                var _scrollIntoView = _asyncToGenerator(
