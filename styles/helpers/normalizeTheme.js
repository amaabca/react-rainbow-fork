    ...
    if (background && (0, _color.isValidColor)(background)) {
        ...
        var theme = {
            background: {
                main: background,
                secondary: dark
                    ? (0, _color.lighten)(background, 0.04)
                    : (0, _color.darken)(background, 0.04),
                highlight: dark
                    ? (0, _color.lighten)(background, 0.15)
                    : (0, _color.darken)(background, 0.1),
                disabled: dark
                    ? (0, _color.lighten)(background, 0.08)
                    : (0, _color.darken)(background, 0.08),
            },
            text: {
                main: mainText,
                title: dark
                    ? (0, _color.darken)(mainText, 0.25)
                    : (0, _color.lighten)(mainText, 0.24),
                header: dark
                    ? (0, _color.darken)(mainText, 0.6)
                    : (0, _color.lighten)(mainText, 0.6),
                label: dark
                    ? (0, _color.darken)(mainText, 0.3)
                    : (0, _color.lighten)(mainText, 0.3),
                disabled: dark
                    ? (0, _color.darken)(mainText, 0.7)
                    : (0, _color.lighten)(mainText, 0.7),
            },
            border: {
                main: dark
                    ? (0, _color.lighten)(background, 0.3)
                    : (0, _color.darken)(background, 0.3),
                divider: dark
                    ? (0, _color.lighten)(background, 0.1)
                    : (0, _color.darken)(background, 0.1),
                disabled: dark
                    ? (0, _color.lighten)(background, 0.1)
                    : (0, _color.darken)(background, 0.1),
...
function normalizeTheme(theme) {
    ...
    return {
        rainbow: _objectSpread(
            _objectSpread(
                {},
                (0, _normalizeThemeColors['default'])({
                    palette: _objectSpread(
                        _objectSpread(_objectSpread({}, _defaultTheme['default'].palette), colors),
            ...
            {
                shadows: _objectSpread(
                    _objectSpread({}, _defaultTheme['default'].shadows),
